...
if("TRUE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/noreply/Manipulator02/src/test2)
  set(test2_DEVEL_PREFIX /home/noreply/Manipulator02/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/noreply/Manipulator02/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer '1 <test@ter.ru>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/noreply/Manipulator02/src/test2/${idir}'.  ${_report}")
    endif()
