...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/noreply/Manipulator02/src/test)
  set(test_DEVEL_PREFIX /home/noreply/Manipulator02/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/noreply/Manipulator02/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer '1 <sdsd@mail.ty>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/noreply/Manipulator02/src/test/${idir}'.  ${_report}")
    endif()
